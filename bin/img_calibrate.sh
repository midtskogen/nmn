...
function solve {
    ...
    solve-field -p --scale-low 15 --odds-to-solve 10000000 -c 0.05 -d 30 -l 600 -m tmp_$count --sigma 1 -o out_$count --overwrite out_$count-0000.tif 2>> calibration.log > /dev/null
