...
<div class="full-width-container" id="satellite-panel-container"><div class="container" id="satellite-panel"><h2>__{{satellite_panel_title}}__</h2><div style="margin-bottom: 6px; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;"><span style="color: #495057; font-size: 0.9em;">__{{satellite_days_label}}__ (UTC)</span><div class="satellite-preset-buttons"><button type="button" class="satellite-preset-btn" data-days="1">__{{satellite_days_1}}__</button><button type="button" class="satellite-preset-btn" data-days="3">__{{satellite_days_3}}__</button><button type="button" class="satellite-preset-btn" data-days="7">__{{satellite_days_7}}__</button></div><span id="satellite-scope-note" style="color: #6c757d; font-size: 0.9em;"></span></div><div class="satellite-range-wrapper"><div class="satellite-range-slider"><div class="satellite-range-track"></div><div class="satellite-range-progress" id="satellite-range-progress"></div><input type="range" id="satellite-range-start" class="satellite-range-input" min="0" max="168" step="1" value="144"><input type="range" id="satellite-range-end" class="satellite-range-input" min="0" max="168" step="1" value="168"></div><div class="satellite-range-ticks" id="satellite-range-ticks"></div><div class="satellite-range-labels"><span id="satellite-range-start-label"></span><span id="satellite-range-end-label"></span></div></div><div style="margin-bottom: 8px;"><input type="text" id="satellite-search-input" placeholder="__{{satellite_search_placeholder}}__" style="width: 100%; box-sizing: border-box; padding: 5px 8px; border: 1px solid #ccc; border-radius: 4px; font-size: 0.9em;"></div><div id="satellite-list"><p style="color: #6c757d; margin: 0;">__{{loading_passes}}__</p></div></div></div>
<div class="full-width-container" id="aircraft-panel-container"><div class="container" id="aircraft-panel"><h2>__{{aircraft_panel_title}}__</h2>
<div style="margin-bottom: 6px; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;"><span style="color: #495057; font-size: 0.9em;">__{{aircraft_days_label}}__ (UTC)</span><div class="satellite-preset-buttons"><button type="button" class="satellite-preset-btn" data-hours="24">__{{aircraft_days_1}}__</button><button type="button" class="satellite-preset-btn" data-hours="72">__{{aircraft_days_3}}__</button><button type="button" class="satellite-preset-btn" data-hours="168">__{{aircraft_days_7}}__</button></div><span id="aircraft-scope-note" style="color: #6c757d; font-size: 0.9em;"></span></div>
<div class="satellite-range-wrapper"><div class="satellite-range-slider"><div class="satellite-range-track"></div><div class="satellite-range-progress" id="aircraft-range-progress"></div><input type="range" id="aircraft-range-start" class="satellite-range-input" min="0" max="168" step="1" value="0"><input type="range" id="aircraft-range-end" class="satellite-range-input" min="0" max="168" step="1" value="168"></div><div class="satellite-range-ticks" id="aircraft-range-ticks"></div><div class="satellite-range-labels"><span id="aircraft-range-start-label"></span><span id="aircraft-range-end-label"></span></div></div>
<div style="margin-bottom: 8px;"><input type="text" id="aircraft-search-input" placeholder="__{{aircraft_search_placeholder}}__" style="width: 100%; box-sizing: border-box; padding: 5px 8px; border: 1px solid #ccc; border-radius: 4px; font-size: 0.9em;"></div>
<div id="aircraft-list"><p style="color: #6c757d; margin: 0;">__{{loading_aircraft}}__</p></div></div></div>
